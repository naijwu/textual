    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className="page">
          ...
          <br/>when not <Link href="/writing/studying">studying</Link>, I spend time as a developer for <Link href="/nwplus">nwPlus ubc</Link> and building <Link href="/democracy">democracy.so</Link> and <Link href="/cohear">cohear.io</Link>.
          <br/>
